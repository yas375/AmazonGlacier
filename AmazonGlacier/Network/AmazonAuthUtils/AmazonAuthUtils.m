...
+ (void)signOperationV4:(MKNetworkOperation *)operation
        withCredentials:(AmazonCredentials *)credentials {
    ...
    NSString *canonicalRequest = [AmazonAuthUtils getCanonicalizedRequest:operation.readonlyRequest.HTTPMethod
                                                                     path:[operation.readonlyRequest.URL path]
                                                                    query:@""
                                                                  headers:[NSMutableDictionary dictionaryWithDictionary:operation.readonlyRequest.allHTTPHeaderFields]
                                                                  payload:@""];
...
+(NSString *)getCanonicalizedRequest:(NSString *)method path:(NSString *)path query:(NSString *)query headers:(NSMutableDictionary *)headers payload:(NSString *)payload
{
    ...
    NSLog(@"AWS4 Content to Hash: [%@]", payload);
